...
개인 급매 화면
 */
public class PerlistFrg extends Fragment    implements OnListItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //layout
        View view = inflater.inflate(R.layout.fragment_perlist, container, false);
        ...
        mAdView =(AdView)view. findViewById(R.id.peradView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        qbtn = (Button)view.findViewById(R.id.pretrieve);
        sbtn = (Button)view.findViewById(R.id.psave); // 저장버튼
        tsearch =  (EditText)view.findViewById(R.id.psearch);
        recyclerView = view.findViewById(R.id.perlist_recyclerview);
        ...
        sbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(PerlistFrg.this)
                        .navigate(R.id.action_main_to_persalein);
            }
        });
        String addr = tsearch.getText().toString();
        ...
        qbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                req.getPsale( addr , new Callback<ResponseBody>() {
                        ...
                        if(response.isSuccessful()){
                            try {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    ListItem vo = new ListItem(seq,nm,tel,addr,"", cont, null,false ,null);
                                    list.add(vo);
    ...
    private void fetchData(ProgressBar progressBar,String bnum) {
        progressBar.setVisibility(View.VISIBLE);
    ...
    private List<ListItem> getServerData(String addr,ProgressBar progressBar) {
        ServerResponse req = new ServerResponse();
